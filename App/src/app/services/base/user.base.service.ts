...
export class UserBaseService {
    ...
    *
    */
    findByRolePrivileges(id: string): Observable<User[]> {
        return this.http
            .get<User[]>(this.contextUrl + '/findByRolePrivileges/' + id)
            .pipe(
    ...
    *
    */
    findByMail(id: string): Observable<User[]> {
        return this.http
            .get<User[]>(this.contextUrl + '/findBymail/' + id)
            .pipe(
                map(response => response)
            );
    }
